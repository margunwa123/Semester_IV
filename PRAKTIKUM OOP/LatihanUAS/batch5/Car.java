...
public class Car {
	...
	*/
	public void fillingFuel(Fuel t_fuel, int amount_in_liter) throws FuelException{
        ...
        System.out.println(String.format("Berhasil isi bensin sebanyak %d liter", amount_in_liter));
    }
	...
	*/
	public void changeGear(int t_gear) throws InvalidInputCarException {
        ...
        this.gear = t_gear;
        System.out.println(String.format("Berhasil mengubah gigi menjadi gigi %d", t_gear));
    }
	...
	*/
	public void changeAcPower(int t_ac_power) throws InvalidInputCarException {
        ...
        System.out.println(String.format("Berhasil mengubah power ac menjadi %d", t_ac_power));
    }
	...
	*/
	public void service(Fuel t_fuel, int amount_in_liter, int t_gear, int t_ac_power) {
        ...
        } catch (TheCarIsOnException TCIOE) {
            System.out.println(TCIOE.getMessage());
        } catch (InvalidInputCarException IICE) {
            System.out.println(IICE.getMessage());
